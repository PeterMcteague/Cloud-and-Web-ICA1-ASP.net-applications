...
namespace Task4Start.SkillService {
    ...
    public interface ISkillService {
        ...
        Task4Start.SkillService.SkillsDTO GetSkill(string skillCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISkillService/GetSkill", ReplyAction="http://tempuri.org/ISkillService/GetSkillResponse")]
        System.Threading.Tasks.Task<Task4Start.SkillService.SkillsDTO> GetSkillAsync(string skillCode);
        ...
        Task4Start.SkillService.SkillsDTO[] GetAllSkills();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISkillService/GetAllSkills", ReplyAction="http://tempuri.org/ISkillService/GetAllSkillsResponse")]
        System.Threading.Tasks.Task<Task4Start.SkillService.SkillsDTO[]> GetAllSkillsAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISkillServiceChannel : Task4Start.SkillService.ISkillService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SkillServiceClient : System.ServiceModel.ClientBase<Task4Start.SkillService.ISkillService>, Task4Start.SkillService.ISkillService {
        ...
        public Task4Start.SkillService.SkillsDTO GetSkill(string skillCode) {
            return base.Channel.GetSkill(skillCode);
        }
        
        public System.Threading.Tasks.Task<Task4Start.SkillService.SkillsDTO> GetSkillAsync(string skillCode) {
            return base.Channel.GetSkillAsync(skillCode);
        }
        
        public Task4Start.SkillService.SkillsDTO[] GetAllSkills() {
            return base.Channel.GetAllSkills();
        }
        
        public System.Threading.Tasks.Task<Task4Start.SkillService.SkillsDTO[]> GetAllSkillsAsync() {
